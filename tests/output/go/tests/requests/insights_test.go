...
func TestInsights_CustomGet(t *testing.T) {
	...
	t.Run("requestOptions should be escaped too", func(t *testing.T) {
		_, err := client.CustomGet(client.NewApiCustomGetRequest(
			...
			insights.QueryParamOption("query", "parameters with space"), insights.QueryParamOption("and an array",
				[]string{"array", "with spaces"}), insights.HeaderParamOption("x-header-1", "spaces are left alone"),
		)
		require.NoError(t, err)
...
func TestInsights_PushEvents(t *testing.T) {
	...
	t.Run("Many events type", func(t *testing.T) {
		_, err := client.PushEvents(client.NewApiPushEventsRequest(
			...
			insights.NewEmptyInsightsEvents().SetEvents(
				[]insights.EventsItems{*insights.ConvertedObjectIDsAfterSearchAsEventsItems(
					insights.NewEmptyConvertedObjectIDsAfterSearch().SetEventType(insights.ConversionEvent("conversion")).SetEventName("Product Purchased").SetIndex("products").SetUserToken("user-123456").SetAuthenticatedUserToken("user-123456").SetTimestamp(1717200000000).SetObjectIDs(
						[]string{"9780545139700", "9780439784542"}).SetQueryID("43b15df305339e827f0ac0bdc5ebcaa7")), *insights.ViewedObjectIDsAsEventsItems(
					insights.NewEmptyViewedObjectIDs().SetEventType(insights.ViewEvent("view")).SetEventName("Product Detail Page Viewed").SetIndex("products").SetUserToken("user-123456").SetAuthenticatedUserToken("user-123456").SetTimestamp(1717200000000).SetObjectIDs(
		...
		ja := jsonassert.New(t)
		ja.Assertf(*echo.Body, `{"events":[{"eventType":"conversion","eventName":"Product Purchased","index":"products","userToken":"user-123456","authenticatedUserToken":"user-123456","timestamp":1717200000000,"objectIDs":["9780545139700","9780439784542"],"queryID":"43b15df305339e827f0ac0bdc5ebcaa7"},{"eventType":"view","eventName":"Product Detail Page Viewed","index":"products","userToken":"user-123456","authenticatedUserToken":"user-123456","timestamp":1717200000000,"objectIDs":["9780545139700","9780439784542"]}]}`)
